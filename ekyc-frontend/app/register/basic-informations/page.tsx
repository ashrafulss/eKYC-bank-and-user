        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-xs border border-gray-100 p-6 md:p-8 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-2">
                <label className="text-sm font-medium text-gray-500">Full Name (Bangla)</label>
                <input
                  type="text"
                  value={formData.fullNameBangla}
                  onChange={(e) => handleChange("fullNameBangla", e.target.value)}
                  className={inputStyles}
                />
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-2">
                <label className="text-sm font-medium text-gray-500">Father's Name (Bangla)</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-2">
                <label className="text-sm font-medium text-gray-500">Mother's Name (Bangla)</label>
                <input
                  type="text"
